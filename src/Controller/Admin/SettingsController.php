...
namespace Kaudaj\Module\FixOrderSlipTotal\Controller\Admin;
 ...
 *
 * @ModuleActivated(moduleName="kjfixordersliptotal", redirectRoute="admin_module_manage")
 */
class SettingsController extends FrameworkBundleAdminController
{
    ...
    public function indexAction(Request $request): Response
    {
        ...
        return $this->render('@Modules/kjfixordersliptotal/views/templates/back/components/layouts/settings.html.twig', [
     ...
     *      redirectRoute="kj_fix_order_slip_total_settings"
     * )
     *
     * @DemoRestricted(redirectRoute="kj_fix_order_slip_total_settings")
     *
     * @param Request $request
     *
    ...
    {
        $this->dispatchHook(
            'actionKJFixOrderSlipTotal' . get_class($this) . 'PostProcess' . $hookName . 'Before',
            ['controller' => $this]
        );

        $this->dispatchHook(
            'actionKJFixOrderSlipTotal' . get_class($this) . 'PostProcessBefore',
            ['controller' => $this]
        );
        ...
        return $this->redirectToRoute('kj_fix_order_slip_total_settings');
    }
    ...
    private function getGeneralFormHandler()
    {
        ...
        $formDataHandler = $this->get('kaudaj.module.fixordersliptotal.form.settings.general_form_data_handler');
